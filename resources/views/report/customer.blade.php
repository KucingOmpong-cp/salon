...
<div id="year">
    <h4 class="card-title text-center">Laporan Pelanggan Tahun 2021</h4>
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                <td colspan="2">TOTAL PENGUNJUNG</td>
                <td>190</td>
            </tr>
        </tbody>
    </table>
...
<div id="month" class="d-none">
    <h4 class="card-title text-center">Laporan Pelanggan Januari 2021</h4>
    <table class="table">
        <thead class="text-primary">
            <th width="1">No</th>
            <th>Tanggal</th>
