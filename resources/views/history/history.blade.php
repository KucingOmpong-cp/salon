                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>selesai</td>
                                    <td>
                                        <button class="btn btn-warning btn-sm px-2" data-toggle="modal" data-target="#paymentModal"><i class="material-icons">payment</i></button>
                                        <button class="btn btn-success btn-sm px-2" data-toggle="modal" data-target="#printModal"><i class="material-icons">print</i></button>
                                    </td>
                                </tr>
                                <tr>
                                    <td>2</td>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content" style="background: #1a2035;">
        ...
        <div class="modal-footer" style="border-top: 0;">
          ...
          <button type="button" class="btn btn-warning px-3"><i class="material-icons mr-1">payment</i>Simpan</button>
        </div>
      </div>
    </div>
</div>
